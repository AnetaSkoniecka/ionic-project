 ...
 */
@Configuration
public class SourceApiConnect {

    @Autowired
    public  void try2() {
        try {

            String url = "https://partnerzyapi.ceneo.pl/AuthorizationService.svc/GetToken?grantType='client_credentials'";
            ...
            //add request header
            con.setRequestProperty("Authorization", "Basic 88dd2902-3de7-4da1-8273-4471f0921a94");
...
//
//    private static final String TOKEN_SERVER_URL = "https://api.dailymotion.com/oauth/token"; // https://api.dailymotion.com/oauth/token
...
//        public static final String API_KEY = "88dd2902-3de7-4da1-8273-4471f0921a94";
//
