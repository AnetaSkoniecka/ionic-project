...
/**
 * @ngdoc function
 * @name ion-fab-button.directive:fabButton
 * @description
 * # Directive for Google Android Floating Action Button
 * # source: http://hafizbilal112.github.io/fab/, http://codepen.io/hafizbilal112/pen/zxWJGd
 * # need to include module 'ion-fab-button', and styles
 */
angular.module('ion-fab-button', [])
    .directive('fabButton', function fabButtonDirective() {
        ...
        function isAnchor(attr) {
            return angular.isDefined(attr.href) 
                || angular.isDefined(attr.ngHref);
        }
        function isLink(attr) {
            return angular.isDefined(attr.uiSref);
        }
        //template
        ...
        function link(scope, element, attr) {
            ...
            if (isLink(attr)) {
                element.attr('ui-sref',attr.uiSref);
            };
